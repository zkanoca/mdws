...
<section class="page_title translucent_bg_color_scheme image_fixed image_bg_14 t_align_c relative wrapper">
    <div class="container">
        <h1 class="color_light fw_light m_bottom_5">Get in Touch</h1>
        <!--breadcrumbs-->
        <ul class="hr_list d_inline_m breadcrumbs">
            ...
            <li><a class="color_grey_light_3 d_inline_m">Contact</a></li>
        </ul>
    </div>
</section>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 m_xs_bottom_30">
            ...
            <div class="form-group">
                ...
                ['class' => 'w_full r_corners fw_light', 'placeholder'=>'Subject']) !!}

            </div>

            <div class="form-group">
                {!!Form::textarea('message', null,
                ['class' => 'w_full r_corners fw_light height_3', 'required'=>'required', 'placeholder'=>'Your
                Message']) !!}
            </div>
            <div class="form-group">

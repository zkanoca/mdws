...
<section class="section_offset">
    ...
    <main class="container t_align_c">
        ...
        <p class="m_bottom_35 heading_2">You can see what we publish and study in this page.</p>

        <div class="row t_align_c">
            <div class="col-lg-4 col-md-4 col-sm-4 m_xs_bottom_30">
                <figure>
                    <div
                        class="icon_wrap_size_6 circle color_blue d_inline_m animation_fill type_2 relative m_bottom_20">
                        <i class="icon-doc-text-1 tr_all"></i>
                    </div>
                    <figcaption>
                        <h5 class="color_dark m_bottom_15"><a class="color_blue"
                        ...
                        <p class="m_bottom_23">All the articles, books, chapters, and other academic publications are
                            listed here</p>
                        <?php /*a href="#"
                           class="button_type_2 color_dark r_corners fs_medium color_blue_hover tr_all d_inline_b">Read
                            More</a */
                        ?>
                    </figcaption>
                </figure>

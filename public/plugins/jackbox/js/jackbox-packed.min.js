(function (c) {
    var M = function (a) {
        a = c.extend(c.Event(a), function () {
            ...
            return{value: c.address.value(), path: c.address.path(), pathNames: c.address.pathNames(), parameterNames: z, parameters: a, queryString: c.address.queryString()}
        }.call(c.address));
    ...
    }, j, F = null, y = "jQueryAddress", H = "hashchange", R = "change", S = "internalChange", T = "externalChange", l = !0, h = !1, d = {autoUpdate: l, crawlable: h, history: l, strict: l, wrap: h}, K = navigator.userAgent.toLowerCase(), w = 9, s = -1 !== K.search("msie"), x = -1 !== K.search("webkit"), f;
    try {
...
(function () {
    ...
    if (E)if (8 === f)ba = /(#|rgb|red|blue|green|black|white|yellow|pink|gray|grey|orange|purple)/, T = /(auto|inherit|rgb|%|#|red|blue|green|black|white|yellow|pink|gray|grey|orange|purple)/, ca = {red: "#F00", blue: "#00F", green: "#0F0", black: "#000", white: "#FFF", yellow: "#FF0", pink: "#FFC0CB", gray: "#808080", grey: "#808080", orange: "#FFA500", purple: "#800080"}; else return; else ba = /(#|rgb)/, T = /(auto|inherit|rgb|%|#)/;
    ...
    var M = {linear: {easenone: function (a, b, c, d) {
        return c * a / d + b
        ...
        return c * a / d + b
    }}, quint: {easeout: function (a, b, c, d) {
    ...
    }}}, ya = {linear: {easenone: "0.250, 0.250, 0.750, 0.750", easein: "0.420, 0.000, 1.000, 1.000", easeout: "0.000, 0.000, 0.580, 1.000", easeinout: "0.420, 0.000, 0.580, 1.000"}, quint: {easein: "0.755, 0.050, 0.855, 0.060", easeout: "0.230, 1.000, 0.320, 1.000", easeinout: "0.860, 0.000, 0.070, 1.000"}, quad: {easein: "0.550, 0.085, 0.680, 0.530", easeout: "0.250, 0.460, 0.450, 0.940", easeinout: "0.455, 0.030, 0.515, 0.955"}, quart: {easein: "0.895, 0.030, 0.685, 0.220", easeout: "0.165, 0.840, 0.440, 1.000", easeinout: "0.770, 0.000, 0.175, 1.000"}, cubic: {easein: "0.550, 0.055, 0.675, 0.190", easeout: "0.215, 0.610, 0.355, 1.000", easeinout: "0.645, 0.045, 0.355, 1.000"}, circ: {easein: "0.600, 0.040, 0.980, 0.335", easeout: "0.075, 0.820, 0.165, 1.000", easeinout: "0.785, 0.135, 0.150, 0.860"}, sine: {easein: "0.470, 0.000, 0.745, 0.715", easeout: "0.390, 0.575, 0.565, 1.000", easeinout: "0.445, 0.050, 0.550, 0.950"}, expo: {easein: "0.950, 0.050, 0.795, 0.035", easeout: "0.190, 1.000, 0.220, 1.000", easeinout: "1.000, 0.000, 0.000, 1.000"}};
    f = s = null
})(window);
...
(function (m) {
    ...
    var e, f, d, l = {touchSwipe: function (a, b) {
...
(function (c) {
    ...
    function dc(a) {
        isNaN(a) ? e = a : (e = c(this).data({id: a, cat: Ra}), Pa[a] = e);
        if (p = e.attr("href") || e.attr("data-href")) {
            var b;
            a = "#" !== p.charAt(0) ? p.toLowerCase().split(".").pop() : "inline";
            b = p;
            if (b = -1 !== b.search("youtube.com") ? "youtube" : -1 !== b.search("vimeo.com") ? "vimeo" : "mp4" === a ? "local" : !1)e.data("type", b), e.attr("data-thumbnail") || ("vimeo" === b ? Xc(e, p) : "youtube" === b && e.attr("data-thumbnail", "http://img.youtube.com/vi/" + p.split("http://www.youtube.com/watch?v=")[1] + "/1.jpg")); else if ("jpg" === a || "png" === a || "jpeg" === a || "gif" === a)e.data("type", "image"); else switch (a) {
                case "mp3":
                    e.data("type", "audio");
                    break;
                case "swf":
            ...
            if (Q = e.attr("data-description")) {
                if (va)if (a = va.indexOf(Q), -1 === a) {
                    ...
                    if (!Q.length)return;
                    va[va.length] = Q
                } else Q = va[a]; else if (Q = c(Q), !Q.length)return;
    ...
    function jc() {
        ...
        if (e = eb[f]) {
            ...
            if (aa)Ta = !0, mc(), nc(); else {
                ...
                I = J.width();
                N = J.height();
                w.css({width: I, height: N, marginLeft: -(I >> 1) - rc, marginTop: -(N >> 1) - sc});
                Jacked.fadeIn(v[0], {callback: ad});
    ...
    function zc() {
        La.css({opacity: 0, visibility: "hidden"})
    }
    ...
    function Ab() {
        ...
        Ia || oc.each(bd);
        Jacked.fadeOut(v[0], {duration: 1E3, callback: jd});
        w.css({marginLeft: kd, marginTop: ld});
    ...
    function md() {
        0 !== Oa && (Ia || s ? $a.scrollTop(Oa) : $a.animate({scrollTop: Oa}, {duration: 300, queue: !1}))
    }
    ...
    function Xc(a, b) {
        c.getJSON("http://vimeo.com/api/v2/video/" + b.split("http://vimeo.com/")[1] + ".json?callback=?", {format: "json"}, function (b) {
    ...
    function pd() {
        ...
        b.length && (a = c("<img />").attr({width: b.attr("width"), height: b.attr("height")}).data("parent", a).one("load.jackbox", qd).insertAfter(b), b.remove(), a.attr("src", d))
    }

    function qd() {
        var a = c(this), b = a.data("parent"), d = parseInt(b.css("width"), 10) || b.width(), m = parseInt(b.css("height"), 10) || b.height(), b = c("<canvas />").addClass("jackbox-canvas-blur").attr({width: d, height: m}).insertBefore(b), m = Date.now(), d = m + 1, m = m + 2;
        a.attr("id", d);
        b.attr("id", m);
    ...
    function rd() {
        var a = c(this);
        a.parent().data({tip: a, tipWidth: a.width() - 27, tipHeight: a.height() + 17}).on("mouseenter.jackbox", sd).on("mouseleave.jackbox", td)
    }
    ...
    function td() {
        ...
        ua ? a.data("tip").css("opacity", 0) : a.data("tip").css({opacity: 0, visibility: "hidden"})
    }
    ...
    var k = {useThumbs: !0, deepLinking: !0, autoPlayVideo: !1, flashVideoFirst: !1, defaultVideoWidth: 960, defaultVideoHeight: 540, thumbnailWidth: 75, thumbnailHeight: 50, useThumbTooltips: !0, dynamic: !1, baseName: "jackbox", className: ".jackbox", preloadGraphics: !0, showInfoByDefault: !1, thumbsStartHidden: !1, showPageScrollbar: !1, useKeyboardControls: !0, fullscreenScalesContent: !0, defaultShareImage: "jackbox/img/default_share.jpg"}, $ = 10, Ea = 2, Rb = "/php/graphics.php", Kb = "/modules/jackbox_swf.html", Sb = "/img/thumbs/default.jpg", Ib = "/modules/jackbox_video.html", Jb = "/modules/jackbox_audio.html", Tb = "/modules/jackbox_social.php", dd = "http://player.vimeo.com/video{url}?title=0&byline=0&portrait=0&autoplay={autoplay}&color=FFFFFF&wmode=transparent", cd = "http://www.youtube.com/embed/{url}?autoplay={autoplay}&autohide=1&hd=1&iv_load_policy=3&showinfo=0&showsearch=0&wmode=transparent", vb = '<div class="jackbox-top clearfix"><div class="jackbox-social"></div><div class="jackbox-top-icons"><span class="jackbox-fullscreen"><span class="jackbox-button jackbox-fs"></span><span class="jackbox-button jackbox-ns"></span></span><span class="jackbox-button jackbox-button-margin jackbox-close"></span></div><div />', wb = '<div class="jackbox-bottom clearfix"><div class="jackbox-controls"><span class="jackbox-button jackbox-arrow-left"></span><span class="jackbox-button jackbox-arrow-right"></span></div><div class="jackbox-title-text"><span class="jb-current"></span><span class="jb-divider">/</span><span class="jb-total"></span><span class="jackbox-title-txt"></span></div><div class="jackbox-bottom-icons"><span class="jackbox-button jackbox-info"></span><span class="jackbox-button-margin jackbox-button-thumbs"><span class="jackbox-button jackbox-hide-thumbs"></span><span class="jackbox-button jackbox-show-thumbs"></span></span></div></div>', kc, C, wa, rc, sc, Ub, Eb, rb, xb, Wa, Vb, Hc, Ja, fb, Ic, F, Db, Wb, V, u, Xb, da, B, P, fa, Y, ea, ta, S, Oa, ja, pa, ca, ka, Z, ra, va, Yb, Gb, Bb, fc, sa, Ma, La, oa, A, Aa, lb, za, Jc, Xa, Kc, Ba, Na, y, ia, Ca, ya, X, hb, xa, kb, Lc, s, gb, sb, Ya, v, E, e, Pa, z, Ha, r, p, q, J, R, Mc, L, n, ma, K, ua, Da, Zb, tc, Qa, x, ac, w, yb, T, tb, Sa, Nc, h, U, Va, I, N, ob, Ob, O, oc, ib, ga, Q, aa, pc, $a, Ga, Ua, jb, Ta, la, M, ld, Pb, eb, Ia, W, Za, pb, ba, qb, qc, kd, Oc, Fa, $b, Qb, wc, ha, bc, G, yc, Pc, Qc, Fb, Ec, Fc, f = 1, H = -1, Ra = 0, ic = !0, gc = !0, Rc = {init: function (a, b) {
        ...
        var a = {type: "text/html", frameborder: 0, mozallowfullscreen: "mozallowfullscreen", webkitallowfullscreen: "webkitallowfullscreen", allowfullscreen: "allowfullscreen"};
        ...
        return function () {
            ...
            z && lb ? (z.show(), P.html(lb).show(), fa = -P.outerHeight(), F.css("height", -fa < n ? -fa : n), Qc ? (Na = !0, z.addClass("jb-info-inactive"), P.css({visibility: "visible", marginTop: 0})) : (Na = !1, P.css("margin-top", fa))) : z && (z.hide(), P.hide());
            Ta = !1;
            ...
            if (!Qb && jb && X) {
                ...
                for (g = 0; g < R; g++) {
                    l = x[g] = c("<div />").data("id", g).addClass("jackbox-thumb").css({width: ha, height: G, left: ga * g}).on("click.jackbox", Cc);
                    ...
                    f.attr({width: l, height: t, src: d[g].attr("data-thumbnail")})
                }
                V[0].appendChild(k);
                Ic = x.length;
                Xb = ga * g;
        ...
        var a = {type: "text/html", frameborder: 0, mozallowfullscreen: "mozallowfullscreen", webkitallowfullscreen: "webkitallowfullscreen", allowfullscreen: "allowfullscreen", scrolling: "no"};
        return function () {
        ...
        var a = {}, b = {duration: 300};
        return function (d, c) {
            if (d)y = f, 0 !== f && f + ra > R && (y = R - ra), Jacked.stopTween(V[0]), V.css("left", y * -ga); else {
                if (0 === f)y = 0; else if (f > y + Wb)for (; f > y + Wb;)y++;
        ...
        return function (d, c) {
            ca.off(".jackbox");
            da.off(".jackbox");
            if ($b)if (s && u.cjSwipe("unbindSwipe"), y < R - ra ? (da.on("click.jackbox", Ac).show(), s && u.cjSwipe("touchSwipeLeft", Ac, !0)) : da.hide(), 0 < y ? (ca.on("click.jackbox", Bc).show(), s && u.cjSwipe("touchSwipeRight", Bc, !0)) : ca.hide(), c)a.left = y * -ga, Jacked.tween(V[0], a, b); else {
                if (d || !Pb) {
                    var e = u.offset().left;
                    ca.css("left", e);
                    da.css("left", e + rb);
        ...
        return function (d) {
            ...
            if (ob < I && Ob + c < N && !Kc)q = T, n = U; else {
                q = I / ob;
                n = N / Ob;
                var e = q > n ? n : q;
                q = T * e;
    ...
    c.jackBox = {available: function (a) {

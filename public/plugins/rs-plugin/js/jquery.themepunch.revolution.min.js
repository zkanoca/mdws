...
(function (e, t) {
    ...
    function L(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (d == 6)U = .6;
            TweenLite.fromTo(B, X, {left: j, top: F, scale: U, opacity: I, rotation: r.rotate}, {opacity: 1, rotation: 0, left: 0, top: 0, scale: 1, ease: W, onComplete: function () {
                q(n, r, f, a, u, i);
        ...
        if (l == 16) {
            ...
            TweenLite.set(i.find(".tp-half-one"), {width: P, height: H / 2, overflow: "visible", zIndex: 10, position: "absolute", top: "0px", left: "0px", transformPerspective: 600, transformOrigin: "center top"});
            ...
            if (i.html() != null)TweenLite.fromTo(u, (N - 200) / 1e3, {opacity: 0, scale: .8, x: r.width * et, y: H * tt, rotation: Z, transformPerspective: 600, transformOrigin: "center center"}, {rotation: 0, scale: 1, x: 0, y: 0, opacity: 1, ease: Power2.easeInOut});
        ...
        if (l == 19 || l == 22) {
            ...
            f.find(".slotslide").each(function (t) {
                var s = e(this);
                TweenLite.fromTo(s, N / 1e3, {left: 0, rotationY: r.rotate, opacity: I, top: 0, scale: .8, transformPerspective: 600, transformOrigin: ut, rotationX: ot}, {left: 0, rotationY: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationX: 0, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)q(n, r, f, a, u, i)
                }});
            ...
            a.find(".slotslide").each(function (t) {
                ...
                var o = -90;
                if (T == 1)o = 90;
                TweenLite.fromTo(s, N / 1e3, {opacity: 1, rotationY: 0, top: 0, z: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationX: 0}, {opacity: 1, rotationY: r.rotate, top: 0, scale: .8, rotationX: o, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)q(n, r, f, a, u, i)
                }});
        ...
        if (l == 20) {
            ...
            f.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(s, N / 1e3, {rotationX: 40, z: -600, opacity: I, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: ot}, {rotationX: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)q(n, r, f, a, u, i)
                }});
        ...
        if (l == 21 || l == 25) {
            ...
            f.find(".slotslide").each(function (t) {
                var s = e(this);
                TweenLite.fromTo(s, N / 1500, {left: 0, rotationX: rot2, z: 0, opacity: 0, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: ot}, {left: 0, rotationX: 0, top: 0, z: 0, scale: 1, rotationY: 0, delay: t * 100 / 1e3 + N / 1e4, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)q(n, r, f, a, u, i)
                }});
        ...
        if (l == 23 || l == 24) {
            ...
            f.find(".slotslide").each(function (t) {
                var s = e(this);
                TweenLite.fromTo(s, N / 1e3, {left: ft, rotationX: r.rotate, opacity: I, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: ot}, {left: 0, rotationX: 0, opacity: 1, top: 0, z: 0, scale: 1, rotationY: 0, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)q(n, r, f, a, u, i)
                }});
                TweenLite.to(s, .1, {opacity: 1, delay: t * 50 / 1e3 + N / 3e3})
            });
            ...
            a.find(".slotslide").each(function (t) {
                var s = e(this);
                TweenLite.fromTo(s, N / 1e3, {left: 0, opacity: 1, rotationX: 0, top: 0, z: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: 0}, {left: ft, opacity: 1, rotationX: r.rotate, top: 0, scale: 1, rotationY: ot, delay: t * 50 / 1e3, ease: Power2.easeInOut, onComplete: function () {
                    if (t == r.slots - 1)q(n, r, f, a, u, i)
                }});
                TweenLite.to(s, .1, {opacity: 0, delay: t * 50 / 1e3 + (N / 1e3 - N / 1e4)})
            })
    ...
    function O(t, n) {
        ...
        if (n.parallax == "mouse" || n.parallax == "scroll+mouse" || n.parallax == "mouse+scroll") {
            ...
            if (s())window.ondeviceorientation = function (n) {
                ...
                var o = 360 / t.width() * i, u = 180 / t.height() * r;
                e(".tp-parallax-container").each(function () {
                    var t = e(this), n = parseInt(t.data("parallaxlevel"), 0) / 100, r = o * n, i = u * n;
                    TweenLite.to(t, .2, {x: r, y: i, ease: Power3.easeOut})
                })
            }
        }
    ...
    function M(t, n) {
        ...
        if (s < u)a = a - (u - s);
        e(".tp-parallax-container").each(function () {
            var t = e(this), n = parseInt(t.data("parallaxlevel"), 0) / 100, r = a * n;
            TweenLite.to(t, .2, {y: r, ease: Power3.easeOut})
        });
        if (n.parallaxBgFreeze != "on") {
            var f = n.parallaxLevels[0] / 100, l = a * f;
    ...
    function D(n, r, i) {
        ...
        var c = l.data("bgposition"), h = l.data("bgpositionend"), p = l.data("zoomstart") / 100, d = l.data("zoomend") / 100, v = l.data("rotationstart"), m = l.data("rotationend"), g = l.data("bgfit"), y = l.data("bgfitend"), b = l.data("easeme"), w = l.data("duration") / 1e3, E = 100;
        if (g == t)g = 100;
        if (y == t)y = 100;
        g = H(g, l, r);
        y = H(y, l, r);
        ...
        l.find(".defaultimg").each(function () {
            ...
            var i = P(r, c, g, n), s = P(r, h, y, n);
            t.data("kenburn", TweenLite.fromTo(n, w, {autoAlpha: 1, transformPerspective: 1200, transformOrigin: "0% 0%", top: 0, left: 0, scale: i.w, x: i.x, y: i.y}, {autoAlpha: 1, rotationZ: m, ease: b, x: s.x, y: s.y, scale: s.w, onUpdate: function () {
    ...
    function J(n, r, i) {
        var o = 0;
        var u = 0;
        var a = n.find(".tp-caption"), f = r.container.find(".tp-static-layers").find(".tp-caption");
            ...
            if (h == 0) {
                                    ...
                                    var a = setInterval(function () {
                                        if (YT != t)if (typeof YT.Player != t && typeof YT.Player != "undefined") {
                                            if (f.data("autoplay") == true) {
                                                u = new YT.Player(p, {events: {onStateChange: R, onReady: function (e) {
                                                    e.target.playVideo()
                                                }}})
                                            } else u = new YT.Player(p, {events: {onStateChange: R}});
                ...
                if (f.find("img").length > 0) {
                    ...
                    if (f.find("iframe").length > 0 || f.find("video").length > 0) {
                        ...
                        if (!f.hasClass("fullscreenvideo"))f.css({"font-size": E.data("fsize") * r.bw + "px", "padding-top": E.data("pt") * r.bh + "px", "padding-bottom": E.data("pb") * r.bh + "px", "padding-left": E.data("pl") * r.bw + "px", "padding-right": E.data("pr") * r.bw + "px", "margin-top": E.data("mt") * r.bh + "px", "margin-bottom": E.data("mb") * r.bh + "px", "margin-left": E.data("ml") * r.bw + "px", "margin-right": E.data("mr") * r.bw + "px", "border-top": E.data("bt") * r.bh + "px", "border-bottom": E.data("bb") * r.bh + "px", "border-left": E.data("bl") * r.bw + "px", "border-right": E.data("br") * r.bw + "px", "line-height": E.data("lh") * r.bh + "px", height: b * r.bh + "px"}); else {
                            o = 0;
                            u = 0;
                            f.data("x", 0);
                            f.data("y", 0);
                        ...
                        f.find(".backcornertop").css({borderWidth: N + "px", right: 0 - N + "px", borderLeft: "0px solid transparent", borderTopColor: C})
                    }
                }
                ...
                TweenLite.set(f, {top: H, left: P, overwrite: "auto"});
                if (a == 0)i = true;
                if (!i) {
                    ...
                    var F = new TimelineLite({smoothChildTiming: true, onStart: j});
                    if (r.fullScreenAlignForce == "on") {
                    }
                    var I = f;
                    ...
                    if (f.data("splitin") == "chars" || f.data("splitin") == "words" || f.data("splitin") == "lines" || f.data("splitout") == "chars" || f.data("splitout") == "words" || f.data("splitout") == "lines") {
                        if (f.find("a").length > 0)f.data("mySplitText", new SplitText(f.find("a"), {type: "lines,words,chars", charsClass: "tp-splitted", wordsClass: "tp-splitted", linesClass: "tp-splitted"})); else f.data("mySplitText", new SplitText(f, {type: "lines,words,chars", charsClass: "tp-splitted", wordsClass: "tp-splitted", linesClass: "tp-splitted"}));
                        f.addClass("splitted")
                    }
                    ...
                    if (a != 2) {
                        if (f.hasClass("customin")) {
                            if (I != f)F.add(TweenLite.set(f, {opacity: 1, scaleX: 1, scaleY: 1, rotationX: 0, rotationY: 0, rotationZ: 0, skewX: 0, skewY: 0, z: 0, x: 0, y: 0, visibility: "visible", opacity: 1, delay: 0, overwrite: "all"}));
                            q.visibility = "hidden";
                    ...
                    f.find(".rs-pendulum").each(function () {
                        ...
                        if (n.data("timeline") == t) {
                            ...
                            var r = n.data("startdeg") == t ? -20 : n.data("startdeg"), i = n.data("enddeg") == t ? 20 : n.data("enddeg");
                            ...
                            n.data("timeline").append(new TweenLite.fromTo(n, speed, {rotation: i, transformOrigin: origin}, {rotation: r, ease: easing, onComplete: function () {
                    ...
                    f.find(".rs-slideloop").each(function () {
                        ...
                        if (n.data("timeline") == t) {
                            n.data("timeline", new TimelineLite);
                            var r = n.data("xs") == t ? 0 : n.data("xs"), i = n.data("ys") == t ? 0 : n.data("ys");
                            ...
                            n.data("timeline").append(new TweenLite.fromTo(n, speed, {x: xe, y: ye}, {x: r, y: i, onComplete: function () {
                                n.data("timeline").restart()
                            }}))
                        }
                    });
                    f.find(".rs-pulse").each(function () {
                        ...
                        if (n.data("timeline") == t) {
                            ...
                            n.data("timeline").append(new TweenLite.fromTo(n, speed, {scale: i}, {scale: r, onComplete: function () {
                                n.data("timeline").restart()
                            }}))
                        }
                    });
                    f.find(".rs-wave").each(function () {
                        ...
                        if (n.data("timeline") == t) {
                            n.data("timeline", new TimelineLite);
                            var r = n.data("angle") == t ? 10 : n.data("angle"), i = n.data("radius") == t ? 10 : n.data("radius"), s = n.data("speed") == t ? -20 : n.data("speed"), o = n.data("origin") == t ? -20 : n.data("origin"), u = {a: 0, ang: r, element: n, unit: i};
                            n.data("timeline").append(new TweenLite.fromTo(u, s, {a: 360}, {a: 0, ease: Linear.easeNone, onUpdate: function () {
                                var e = u.a * (Math.PI / 180);
                                TweenLite.to(u.element, .1, {x: Math.cos(e) * u.unit, y: u.unit * (1 - Math.sin(e))})
                            }, onComplete: function () {
                                n.data("timeline").restart()
                            }}))
                        }
